...
GOOD_TEST_GAME_FILE = os.path.join(TEST_DATA_DIR, "distribution_right.csv")
...
def test_player_plays_against_itself():
    game.drop_games()
...
def test_player_plays_against_same_opponent_twice():
    game.drop_games()
...
def test_player_plays_game_twice():
    game.drop_games()
...
def test_player_plays_time_twice():
    game.drop_games()
